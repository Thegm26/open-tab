...
export const CATALOG: Record<MerchantSlug, { name: string; items: readonly { sku: string; name: string; priceCents: number }[] }> = {
  cafe: { name: "Café Sol", items: [{ sku: "espresso", name: "Espresso", priceCents: 280 }, { sku: "dinner", name: "Dinner plate", priceCents: 780 }, { sku: "toast", name: "Tomato toast", priceCents: 500 }, { sku: "lemonade", name: "Lemonade", priceCents: 250 }] },
  bakery: { name: "Bread & Butter Bakery", items: [{ sku: "croissant", name: "Butter croissant", priceCents: 180 }, { sku: "lunch", name: "Lunch basket", priceCents: 450 }, { sku: "sourdough", name: "Sourdough loaf", priceCents: 450 }, { sku: "cookie", name: "Sea-salt cookie", priceCents: 250 }] },
};
